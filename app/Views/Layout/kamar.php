...
<head>
  ...
  <title>Selamat Datang di Hotel Trinova</title>
  ...
  <!-- Google Fonts -->
  <link href="landing_page/https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet">
...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.html"><marquee>Hotel<span class="color-b">Trinova</marquee></span></a>
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="kamar">Fasilitas Kamar</a>
          </li>

          <li class="nav-item">
            <a class="nav-link " href="hotel">Fasilitas Hotel</a>
